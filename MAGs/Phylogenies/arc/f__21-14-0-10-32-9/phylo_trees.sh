...
#SBATCH --mem=85000
#SBATCH --job-name="f__21-14-0-10-32-9"
...
do
    grep -A 1 $line /mnt/big/miniconda3/envs/protologger/share/gtdbtk-1.5.0/db/pplacer/gtdb_r202_ar122.refpkg/ar122_msa_reps_r202.faa >> repr_seqs.aln ; 
done < repr_accessions_numbers.tsv 

# From the GTDB-Tk alignment of our MAGs, get the alignments of the novel taxa of interest
while IFS= read -r line; 
do
    grep -A 1 -w $line /home1/christina/Elos_meta/Curtain3/metaWRAP/GTDB_TK_bins_classification/elos_70_5.ar122.user_msa.fasta  >> users_msa.aln ;
done < my_mags.tsv
